...
const RecipeCard = ({ recipe }: RecipeCardProps) => {
  ...
  return (
    <Card className="w-full min-w-[254px] max-w-md max-h-[580px] flex flex-col">
      ...
      <CardBody className="flex-1 text-black pt-0">
        <p className="text-gray-600 overflow-y-auto line-clamp-6">
